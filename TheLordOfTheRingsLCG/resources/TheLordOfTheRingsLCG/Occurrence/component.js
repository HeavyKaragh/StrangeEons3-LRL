...
function createInterface(diy, editor, sheet) {
    ...
    Main_tab.editorTabScrolling = true;
        ...
        Effect_panel.place(Story_control, 'hfill', Effect_control, 'br hfill', Occurrence1_control, 'br hfill', Occurrence2_control, 'br hfill');
    ...
    Encounterset_tab.editorTabScrolling = true;
        ...
        Encounterset_panel.place(Encounterset_control, 'hfill', Difficulty_control, 'br hfill', EncountersetPortrait_control, 'br hfill');
    ...
    Template_tab.editorTabScrolling = true;
        ...
        if (advancedControls) {
            ...
            CustomRegion_panel.place(CustomRegion_control, 'br hfill');
...
function paintFront(g, diy, sheet) {
    ...
    if ($Encounterset != 'EmptyIcon') {
        ...
        writeLine(formatTitle(diy, g), Title_writer, diy.settings.getRegion('Title-EmptyIcon'), g);
    }

    writeParagraph(['Story'], Body_writer, diy.settings.getRegion('Story'), diy, g);
    switch ($Template) {
    case 'Complex':
        writeParagraph(['Effect'], Body_writer, diy.settings.getRegion('Complex-Body'), diy, g);
        ...
        break;
    case 'Dual':
        writeParagraph(['Effect'], Body_writer, diy.settings.getRegion('Dual-Body'), diy, g);
