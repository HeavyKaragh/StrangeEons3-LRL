// texto ship-objective
//añadir Nightmare

/* COMPONENT CONFIGURATION */
const Card = 'ObjectiveAlly';
const CardVersion = 1;
...
function createInterface(diy, editor, sheet) {
    ...
    Main_tab.editorTabScrolling = true;
        ...
        Stats_panel.place(Willpower_control, '', Attack_control, '', Defense_control, '', HitPoints_control, '');
    ...
    if (advancedControls) {
        ...
        list = new Array('Standard', 'Ship', 'Boon');
...
function paintFront(g, diy, sheet) {
    ...
    if ($Template != 'Boon') paintIconLRL('Encounterset', diy, g, sheet);
    ...
    writeBody(['Effect', 'Shadow', 'Flavour'], diy, g);

    writeScenario(diy, g);
    if ($Template != 'Boon') writeEncountersetNumber(diy, g);
