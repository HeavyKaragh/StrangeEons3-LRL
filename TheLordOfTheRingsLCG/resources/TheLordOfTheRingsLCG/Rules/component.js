...
function createInterface(diy, editor, sheet) {
    ...
    Main_tab.editorTabScrolling = true;
        ...
        TextBox_panel.place(StoryFront_control, 'hfill', TextFront_control, 'br hfill', FlavourFront_control, 'br hfill');
...
function paintBack(g, diy, sheet) {
    ...
    writeParagraph(['StoryBack', 'RulesBack', 'FlavourBack'], Body_writer, diy.settings.getRegion('BodyBack-' + $PortraitBack-layout), diy, g);
