...
function createInterface(diy, editor, sheet) {
    ...
    Main_tab.place(Title_panel, 'hfill');
        ...
        Stats_panel.place(Threat_control, '', Progress_control, 'grow');
    ...
    Encounterset_tab.editorTabScrolling = true;
        ...
        if (advancedControls) {
            list = new Array('Standard', 'Gold', 'Red', 'Green', 'Blue', 'Purple', 'Yellow', 'Brown', 'Mulberry', 'White', 'Grey', 'Black', 'Cyan', 'Magenta', 'CustomDifficulty');
