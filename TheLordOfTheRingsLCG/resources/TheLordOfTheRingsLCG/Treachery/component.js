...
// MAIN TAB
	...
	let Trait_control = new uiText('Trait' , bindings , [ FRONT ] ) ;
	...
	let OptionSpecial_control = new uiIconList('OptionSpecial' , GO.OptionSpecialList , bindings ) ;
...
// ENCOUNTER SET TAB
	...
	let EncounterSetNumber_control = new uiSpinner('EncounterSetNumber' , bindings ) ;
	let EncounterSetTotal_control = new uiSpinner('EncounterSetTotal' , bindings ) ;
	...
	if( advancedControls ){
		let difficultyList = new Array('Standard' , 'Gold' , 'Red' , 'Green' , 'Blue' , 'Purple' ) ;
		let Difficulty_control = new uiIconList('Difficulty' , difficultyList , bindings ) ;
...
// TEMPLATE TAB
	...
	if( advancedControls ){
		...
		let templateList = new Array('Standard' , 'Nightmare' , 'Burden' ) ;
...
//	}
//	if( $Template == 'Burden' ){
//		region = diy.settings.getRegion('Burden-Body' ) ; 
//		Body_writer.setPageShape( diy.settings.getCupShape('Burden-Body-shape' ) ) ;
//	}else{ 
//		region = diy.settings.getRegion('Body' ) ;
