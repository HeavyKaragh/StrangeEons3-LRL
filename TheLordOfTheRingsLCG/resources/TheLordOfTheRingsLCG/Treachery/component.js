...
// MAIN TAB
	...
	let OptionSpecial_control = new uiListIconLabeled('OptionSpecial',GO.OptionSpecialList,bindings) ;
...
// ENCOUNTER SET TAB
	...
	if(advancedControls){
		...
		let Difficulty_control = new uiListIconLabeled('Difficulty',list,bindings) ;
...
// TEMPLATE TAB
	...
	if(advancedControls){
		...
		let list = new Array('Standard','Nightmare','Burden') ;
